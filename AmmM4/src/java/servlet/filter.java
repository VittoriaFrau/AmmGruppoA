...
public class filter extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String command = request.getParameter("cmd"); //vedi ricerca.js
        
        if(command != null){
            if(command.equals("search") && request.getParameter("q")!= null){
                List<amm.modelli.Object> listaOggetti = ObjectFactory.getInstance().ricercaOggetto(request.getParameter("q"));
                ...
                response.setHeader("Cache-Control", "no-store, no-cache, "
                                   + "must-revalidate");
                // Genero il json 
                request.getRequestDispatcher("popola.jsp"). //collegamento jsp
